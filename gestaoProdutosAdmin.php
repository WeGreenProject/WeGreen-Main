...
<body>
  <div class="dashboard-container">
    ...
    <main class="main-content">
      ...
      <!-- Modais agora são criados via SweetAlert2 - veja gestaoProdutos.js -->
  ...
  <script>
      ...
      Swal.fire({
        html: `
          <div style="padding: 20px 0;">
            ...
            <h2 style="margin: 0 0 12px 0; color: #1e293b; font-size: 24px; font-weight: 700;">Terminar Sessão?</h2>
          ...
          Swal.fire({
            html: `
              <div style="padding: 20px;">
                ...
                <p style="margin: 0; color: #64748b; font-size: 15px;">A terminar sessão...</p>
              </div>
              <style>
                @keyframes spin {
    ...
    // Override da função getInfoUserDropdown para evitar sobrescrever o dropdown
    function getInfoUserDropdown() {
      // Já está criado no PHP, não fazer nada
      return;
    }
    ...
    // Modais agora são gerenciados via SweetAlert2 - veja gestaoProdutos.js

    // Fechar modal ao clicar no botão X ou fora do conteúdo
    document.addEventListener('click', function(e) {
