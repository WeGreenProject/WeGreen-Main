            ...
            <nav class="sidebar-menu">
                <div class="menu-section">
                    ...
                    <a href="meusFavoritos.php" class="menu-item active">
                        ...
                        <span class="badge" id="sidebarFavCount" style="display:none; background:#3cb371; color:white; padding:2px 8px; border-radius:10px; font-size:11px; margin-left:auto;"></span>
                    </a>
            ...
            <div class="page-content">
                <header class="dashboard-header">
                    <div class="header-title">
                        <h1><i class="fas fa-heart text-danger"></i> Meus Favoritos</h1>
                ...
                <div class="content-area">
                    ...
                    <div class="filtros-favoritos">
                        ...
                        <div class="filtro-item">
                            <label><i class="fas fa-tag"></i> Disponibilidade</label>
                        ...
                        <div class="filtro-item" style="display:flex; align-items:end;">
                            <span class="badge-contador" id="totalFavoritos">0 produtos</span>
                        </div>
                    </div>
