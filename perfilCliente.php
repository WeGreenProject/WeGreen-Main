                ...
                <div class="content-area">
                    ...
                    <div class="profile-header-card">
                        <div class="profile-avatar-large">
                            <img src="https://ui-avatars.com/api/?name=<?php echo urlencode($_SESSION['nome'] ?? 'Cliente'); ?>&background=3cb371&color=fff" alt="Perfil">
                        </div>
                    ...
                    <div class="profile-section">
                        ...
                        <form id="profileForm">
                            ...
                            <div class="info-item">
                                ...
                                <input type="text" id="morada" placeholder="Rua, Número, Código Postal, Cidade">
                            </div>
