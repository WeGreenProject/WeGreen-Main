...
$user_plano = (int)($_SESSION['plano'] ?? 1);

if ($_SESSION['tipo'] == 3 && $user_plano < 2) {
    
    header('Location: planos.php?msg=relatorios_upgrade');
    exit;
}
?>
...
<body>
      ...
      <div id="passwordModal" class="modal">
        <div class="modal-content" style="max-width: 500px;">
          ...
          <form id="passwordForm" class="profile-form" style="margin-top: 20px;">
            <input type="text" name="username" autocomplete="username" value="<?php echo $_SESSION['email'] ?? ''; ?>"
  ...
  <script src="src/js/relatoriosAnunciante.js"></script>
