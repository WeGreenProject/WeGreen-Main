                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 25px 0; color: #4b5563; font-size: 16px; line-height: 1.6;">
                                Recebemos um pedido para redefinir a password da sua conta. Clique no botão abaixo para criar uma nova password.
                            </p>
                                ...
                                <tr>
                                    <td>
                                        <p style="margin: 0; color: #92400e; font-size: 14px;">
                                            <strong>Atenção:</strong> Este link expira em 1 hora (<?php echo date('d/m/Y H:i', strtotime('+1 hour')); ?>)
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <p style="margin: 0 0 10px 0; color: #4b5563; font-size: 14px; line-height: 1.6;">
                                Se não solicitou esta alteração, ignore este email. A sua password permanecerá inalterada.
                            </p>
                    ...
                    <tr>
                        <td style="background-color: #f9fafb; padding: 30px 40px; text-align: center; border-top: 1px solid #e5e7eb;">
                            <p style="margin: 0 0 10px 0; color: #6b7280; font-size: 12px;">
                                Este email foi enviado porque solicitou a recuperação de password
                            </p>
