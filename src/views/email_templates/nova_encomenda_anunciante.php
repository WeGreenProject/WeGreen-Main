                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 25px 0; color: #4b5563; font-size: 16px; line-height: 1.6;">
                                Boa notícia! Acabou de receber uma nova encomenda. Por favor, processe-a o mais rápido possível para garantir a satisfação do cliente.
                            </p>
                            ...
                            <table width="100%" cellpadding="15" cellspacing="0" style="background-color: #eff6ff; border-radius: 6px; margin-bottom: 25px; border: 1px solid #bfdbfe;">
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td style="border-top: 1px solid #bfdbfe; padding-top: 15px;">
                                        ...
                                        <p style="margin: 0; color: #1e40af; font-size: 14px;">
                                            ...
                                            <span style="background-color: #22c55e; color: #ffffff; padding: 3px 8px; border-radius: 4px; font-size: 12px;">
                            ...
                            <table width="100%" cellpadding="15" cellspacing="0" style="background-color: #f0fdf4; border-radius: 6px; margin-bottom: 25px; border: 1px solid #86efac;">
                                <tr>
                                    <td>
                                        ...
                                        <p style="margin: 0 0 5px 0; color: #047857; font-size: 14px;">
                                            <strong>Comissão WeGreen (6%):</strong> -€<?php echo number_format($comissao, 2, ',', '.'); ?>
                                        </p>
                    ...
                    <tr>
                        <td style="background-color: #f9fafb; padding: 30px 40px; text-align: center; border-top: 1px solid #e5e7eb;">
                            ...
                            <p style="margin: 0 0 15px 0; color: #9ca3af; font-size: 13px;">
                                ...
                                <a href="mailto:vendedores@wegreen.pt" style="color: #3b82f6; text-decoration: none;">vendedores@wegreen.pt</a>
                            </p>
